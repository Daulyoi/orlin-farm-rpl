<div class="product-card">
    <div class="product-card__img">
        <img src="{{  asset($hewanQurban->foto) }}" alt="{{ $hewanQurban->jenis }}">
    </div>
    <div class="product-card__info">
        <div class="product-card__title flex">{{ $hewanQurban->jenis }}
            <p class="product-card__kelamin">{{ $hewanQurban->kelamin }}</p>
        </div>
        <div class="product-card__info-text">
            ...
            <p>Rp. {{ number_format($hewanQurban->harga) }}</p>
        </div>
        <div class="product-card__info-text">
        ...
        <div class="product-card__info-text">
            ...
            <p class="description">{{ $hewanQurban->deskripsi }}</p>
        </div>
        <div class="product-card__info-text">
            ...
            <p>{{ $hewanQurban->lokasi }}</p>
        </div>
        <form method="POST" action="{{ route('pelanggan.keranjang.store') }}">
            @csrf
            <input type="hidden" name="id_hewan" value="{{ $hewanQurban->id }}">
            <button type="submit" class="product-card__button">Tambahkan ke Keranjang</button>
        </form>
    </div>
</div>
